...
CREATE TABLE lugar(
    ...
    CONSTRAINT fk_lugar FOREIGN KEY(lugar_fk_lugar) REFERENCES lugar(lugar_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Persona_Juridica (
    ...
    CONSTRAINT fk_lugar_fiscal FOREIGN KEY(pj_fk_lugar_fiscal) REFERENCES lugar(lugar_codigo) ON DELETE CASCADE,
    CONSTRAINT fk_lugar_fisica FOREIGN KEY(pj_fk_lugar_fisica) REFERENCES lugar(lugar_codigo) ON DELETE CASCADE
);
...
CREATE TABLE cliente_juridico(
    ...
    CONSTRAINT fk_persona_juri FOREIGN KEY(cj_fk_persona_juri) REFERENCES Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE
);
...
CREATE TABLE proveedor(
    ...
    CONSTRAINT fk_persona_juri FOREIGN KEY(prov_fk_persona_juri) REFERENCES Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE,
...
CREATE TABLE Persona_Natural (
    ...
    Constraint FK_lugar_pers_nat foreign key (FK_lugar_fiscal) references Lugar(lugar_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Cliente_Natural (
    ...
    Constraint FK_per_nat_cliente_natural foreign key (FK_persona_nat) references Persona_Natural (persona_nat_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Empleado (
    ...
    Constraint FK_per_nat_empleado foreign key (FK_persona_nat) references Persona_Natural (persona_nat_codigo) ON DELETE CASCADE
);
...
CREATE TABLE usuario(
    ...
    CONSTRAINT fk_persona_nat FOREIGN KEY(usuario_fk_persona_nat) REFERENCES Persona_Natural(persona_nat_codigo) ON DELETE CASCADE,
    CONSTRAINT fk_persona_jur FOREIGN KEY(usuario_fk_persona_jur) REFERENCES Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE,
    CONSTRAINT fk_rol FOREIGN KEY(usuario_fk_rol) REFERENCES rol(rol_codigo) ON DELETE CASCADE
);
...
CREATE TABLE rol_privilegio(
    ...
    CONSTRAINT fk_privilegio FOREIGN KEY(rp_fk_privilegio) REFERENCES privilegio(privilegio_codigo) ON DELETE CASCADE
);
...
CREATE TABLE contacto(
    ...
    CONSTRAINT fk_empleado FOREIGN KEY(contacto_fk_empleado) REFERENCES Empleado(cod_empleado) ON DELETE CASCADE
);
...
CREATE TABLE Telefono (
    ...
    Constraint FK_perjur_telf foreign key (FK_persona_jur) references Persona_juridica (persona_jur_codigo) ON DELETE CASCADE,
    Constraint FK_pernat_telf foreign key (FK_persona_nat) references Persona_Natural (persona_nat_codigo) ON DELETE CASCADE,
    Constraint FK_contacto_telf foreign key (FK_contacto) references Contacto (contacto_id) ON DELETE CASCADE
);
...
CREATE TABLE Correo (
    ...
    Constraint FK_perjur_correo foreign key (FK_persona_jur) references Persona_juridica (persona_jur_codigo) ON DELETE CASCADE,
    Constraint FK_pernat_correo foreign key (FK_persona_nat) references Persona_Natural (persona_nat_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Emp_Titulo (
    ...
    Constraint FK_emple_emp_titulo foreign key (FK_empleado) references Empleado (cod_empleado) ON DELETE CASCADE,
    Constraint FK_titulo_emp_titulo foreign key (FK_titulo_codigo) references titulo (titulo_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Beneficiario_Empleado (
    ...
    Constraint FK_emple_benf_empl foreign key (FK_empleado) references Empleado (cod_empleado) ON DELETE CASCADE,
    Constraint FK_per_nat_ben_empl foreign key (FK_persona_nat) references Persona_Natural (persona_nat_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Contrato_de_personal (
    ...
    Constraint FK_empleado_contratodp foreign key (FK_empleado) references Empleado (cod_empleado) ON DELETE CASCADE
);
...
CREATE TABLE Vacacion (
    ...
    Constraint FK_contrato_vacacion foreign key (FK_contrato) references Contrato_de_personal (contrato_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Contrato_P_Beneficio (
    ...
    Constraint FK_contratop_ben_beneficio foreign key (FK_beneficio) references Beneficio(beneficio_codigo) ON DELETE CASCADE,
    Constraint FK_contrato_p_ben_contrato foreign key (FK_contrato) references Contrato_de_personal(contrato_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Contrato_Cargo (
    ...
    Constraint FK_contrato_cargo_cargo foreign key (FK_cargo) references Cargo(cargo_codigo) ON DELETE CASCADE,
    Constraint FK_contrato_cargo_contrato foreign key (FK_contrato) references Contrato_De_Personal(contrato_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Asistencia (
    ...
    Constraint FK_asistencia_contrato foreign key (FK_contrato) references Contrato_De_Personal(contrato_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Contrato_Horario (
    ...
    Constraint FK_contrato_horario_horario foreign key (FK_codigo_horario) references Horario(horario_codigo) ON DELETE CASCADE,
    Constraint FK_contrato_horario_contrato foreign key (FK_codigo_contrato) references Contrato_De_Personal(contrato_codigo) ON DELETE CASCADE
);
...
CREATE TABLE SEDE (
    ...
    Constraint FK_sede_lugar foreign key (FK_lugar) references Lugar(lugar_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Area (
    ...
    Constraint FK_area_sede foreign key (FK_sede) references Sede(sede_id) ON DELETE CASCADE
);
...
CREATE TABLE Zona (
    ...
    Constraint FK_zona_area foreign key (FK_area) references Area(area_id) ON DELETE CASCADE
);
...
CREATE TABLE Equipo (
    ...
    Constraint FK_equipo_cont_per foreign key (FK_cont_per) references Contrato_de_personal(contrato_codigo) ON DELETE CASCADE,
    Constraint FK_equipo_zona foreign key (FK_zona) references Zona(zona_id) ON DELETE CASCADE
);
...
CREATE TABLE Almacen (
    ...
    Constraint FK_almacen_sede foreign key (FK_sede) references Sede(sede_id) ON DELETE CASCADE
);
...
CREATE TABLE tdc(
    ...
    constraint fk_persona_nat foreign key(tdc_fk_persona_nat) references Persona_Natural(persona_nat_codigo) ON DELETE CASCADE,
    constraint fk_persona_jur foreign key(tdc_fk_persona_jur) references Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE,
    constraint fk_banco foreign key(tdc_fk_banco) references banco(banco_codigo) ON DELETE CASCADE
);
...
CREATE TABLE tdd(
    ...
    constraint fk_persona_nat foreign key(tdd_fk_persona_nat) references Persona_Natural(persona_nat_codigo) ON DELETE CASCADE,
    constraint fk_persona_jur foreign key(tdd_fk_persona_jur) references Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE,
    constraint fk_banco foreign key(tdd_fk_banco) references banco(banco_codigo) ON DELETE CASCADE
);
...
CREATE TABLE cheque(
    ...
    constraint fk_persona_nat foreign key(cheque_fk_per_nat) references Persona_Natural(persona_nat_codigo) ON DELETE CASCADE,
    constraint fk_persona_jur foreign key(cheque_fk_per_jur) references Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE,
    constraint fk_banco foreign key(cheque_fk_banco) references banco(banco_codigo) ON DELETE CASCADE
);
...
CREATE TABLE efectivo(
    ...
    constraint fk_persona_nat foreign key(efectivo_fk_per_nat) references Persona_Natural(persona_nat_codigo) ON DELETE CASCADE,
    constraint fk_persona_jur foreign key(efectivo_fk_per_jur) references Persona_Juridica(persona_jur_codigo) ON DELETE CASCADE
);
...
CREATE TABLE Mate_P_Proveedor (
  ...
  CONSTRAINT FK_materia_prima_mate_p_proveedor FOREIGN KEY (FK_materia_prima) REFERENCES Materia_Prima(materia_p_id) ON DELETE CASCADE,
  CONSTRAINT FK_proveedor_mate_p_proveedor FOREIGN KEY (FK_prov) REFERENCES Proveedor(cod_proveedor) ON DELETE CASCADE
);
...
CREATE TABLE Prueba_Material (
  ...
  FK_materia_p_pm INTEGER NOT NULL,
    ...
    CONSTRAINT FK_tipo_prueba_mate_prueba_material FOREIGN KEY (FK_tipo_pm) REFERENCES Tipo_Prueba_Mate(tipo_pm_id) ON DELETE CASCADE,
    CONSTRAINT FK_materia_prima_prueba_material FOREIGN KEY (FK_materia_p_pm) REFERENCES Materia_Prima(materia_p_id) ON DELETE CASCADE
);
...
CREATE TABLE Historico_Estatus_Prueba_Mate (
    ...
    CONSTRAINT FK_estatus_prueba_mate_historico FOREIGN KEY (FK_estatus_pm) REFERENCES estatus_prueba_mate(estatus_pm_id) ON DELETE CASCADE,
    CONSTRAINT FK_prueba_mate_historico FOREIGN KEY (FK_prueba_mate) REFERENCES Prueba_Material(cod_prueb_map) ON DELETE CASCADE
);
...
CREATE TABLE Orden_De_Reposicion (
    ...
    CONSTRAINT FK_contrato_orden_de_reposicion FOREIGN KEY (FK_contrato_per) REFERENCES Contrato_de_personal(contrato_codigo) ON DELETE CASCADE,
    CONSTRAINT FK_tasa_dolar_orden_de_reposicion FOREIGN KEY (FK_tasa_dolar) REFERENCES Historico_Tasa_Dolar(H_tasa_id) ON DELETE CASCADE
);
...
CREATE TABLE Historico_Estatus_Orden (
    ...
    CONSTRAINT FK_orden_historico_estatus FOREIGN KEY (FK_orden_rep) REFERENCES Orden_De_Reposicion(orden_id) ON DELETE CASCADE,
    CONSTRAINT FK_estatus_orden_historico FOREIGN KEY (FK_estatus_orden) REFERENCES Estatus_Orden(estatus_ord_id) ON DELETE CASCADE
);
...
CREATE TABLE Tipo_Prueba_Pieza (
    ...
    CONSTRAINT FK_zona_tipo_prueba_pieza FOREIGN KEY (FK_zona_tip_pru_pie) REFERENCES Zona(zona_id) ON DELETE CASCADE
);
...
CREATE TABLE Modelo_Avion (
    ...
    modelo_avion_precio DECIMAL(10,2) NOT NULL,
...
CREATE TABLE avion(
    ...
    CONSTRAINT fk_modelo FOREIGN KEY(avion_fk_modelo) REFERENCES Modelo_Avion(modelo_avion_id) ON DELETE CASCADE
);
...
CREATE TABLE Prueba_Avion(
    ...
    CONSTRAINT fk_avion FOREIGN KEY(prueba_avion_fk_avion) REFERENCES avion(avion_id) ON DELETE CASCADE,
    CONSTRAINT fk_tipo_prueba_avion FOREIGN KEY(prueba_avion_fk_tipo_p_avion) REFERENCES tipo_prueba_avion(tipo_pa_id) ON DELETE CASCADE
);
...
CREATE TABLE Historico_Estatus_Prueba_Avion(
    ...
    CONSTRAINT fk_prueba_avion_historico FOREIGN KEY(FK_prueba_avion) REFERENCES Prueba_Avion(prueba_avion_id) ON DELETE CASCADE,
    CONSTRAINT fk_estatus_prueba_avion_historico FOREIGN KEY(FK_estatus_prueb_avion) REFERENCES estatus_prueba_avion(estatus_pa_id) ON DELETE CASCADE
);
...
CREATE TABLE Modelo_Avion_Caracteristica(
    ...
    CONSTRAINT fk_modelo_modelo_avion_caracteristica FOREIGN KEY(modelo_avion_caract_fk_modelo) REFERENCES Modelo_Avion(modelo_avion_id) ON DELETE CASCADE,
    CONSTRAINT fk_caracteristica_modelo_avion_caracteristica FOREIGN KEY(modelo_avion_caract_fk_caract) REFERENCES Caracteristica(caracteristica_id) ON DELETE CASCADE
);
...
CREATE TABLE Historico_Precio_Venta(
    ...
    CONSTRAINT fk_tasa_dolar_historico_precio_venta FOREIGN KEY(fk_precio_venta_H_tasa_dolar) REFERENCES Historico_Tasa_Dolar(H_tasa_id) ON DELETE CASCADE,
    CONSTRAINT fk_avion_historico_precio_venta FOREIGN KEY(fk_precio_venta_avion) REFERENCES avion(avion_id) ON DELETE CASCADE
);
...
CREATE TABLE Empleado_Prueba_Material(
    ...
    CONSTRAINT fk_empleado_empleado_prueba_material FOREIGN KEY(fk_empleado) REFERENCES Empleado(cod_empleado) ON DELETE CASCADE,
    CONSTRAINT fk_prueba_material_empleado_prueba_material FOREIGN KEY(fk_prueba_material) REFERENCES Prueba_Material(cod_prueb_map) ON DELETE CASCADE
);
...
CREATE TABLE Empleado_Prueba_Avion(
    ...
    CONSTRAINT fk_empleado_empleado_prueba_avion FOREIGN KEY(fk_empleado) REFERENCES Empleado(cod_empleado) ON DELETE CASCADE,
    CONSTRAINT fk_prueba_avion_empleado_prueba_avion FOREIGN KEY(fk_prueba_avion) REFERENCES Prueba_Avion(prueba_avion_id) ON DELETE CASCADE
);
...
CREATE TABLE Componente(
    ...
    CONSTRAINT fk_pieza_principal_componente FOREIGN KEY(componente_fk_pieza_principal) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_pieza_componente_componente FOREIGN KEY(componente_fk_pieza_componente) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE
); 
...
CREATE TABLE modelo_p_caracteristica(
    ...
    CONSTRAINT fk_modelo_modelo_pieza_caracteristica FOREIGN KEY(m_p_caract_fk_modelo) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_caracteristica_modelo_pieza_caracteristica FOREIGN KEY(m_p_caract_fk_caract) REFERENCES Caracteristica(caracteristica_id) ON DELETE CASCADE
);
...
CREATE TABLE mat_prima_pieza(
    ...
    CONSTRAINT fk_pieza_mat_prima_pieza FOREIGN KEY(fk_pieza) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_mat_prima_mat_prima_pieza FOREIGN KEY(fk_mat_prima) REFERENCES Materia_Prima(materia_p_id) ON DELETE CASCADE
);
...
CREATE TABLE Pieza(
    ...
    CONSTRAINT fk_modelo_pieza FOREIGN KEY(pieza_fk_modelo_p) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE
);
...
CREATE TABLE Inventario_Almacen (
    ...
    Constraint FK_inventario_pieza foreign key (FK_pieza) references Pieza(pieza_id) ON DELETE CASCADE
);
...
CREATE TABLE Detalle_Orden_Reposicion (
    ...
    CONSTRAINT FK_orden_detalle_orden_reposicion FOREIGN KEY (FK_orden) REFERENCES Orden_De_Reposicion(orden_id) ON DELETE CASCADE,
    CONSTRAINT FK_mate_prov_detalle_orden_reposicion FOREIGN KEY (FK_mp_prov) REFERENCES Mate_P_Proveedor(materia_p_prov_id) ON DELETE CASCADE
);
...
CREATE TABLE Pieza_Avion(
    ...
    CONSTRAINT fk_pieza_pieza_avion FOREIGN KEY(pieza_avion_fk_pieza) REFERENCES Pieza(pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_avion_pieza_avion FOREIGN KEY(pieza_avion_fk_avion) REFERENCES avion(avion_id) ON DELETE CASCADE
);
...
CREATE TABLE Prueba_Pieza(
    ...
    CONSTRAINT fk_pieza_prueba_pieza FOREIGN KEY(prueba_pieza_fk_pieza) REFERENCES Pieza(pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_tipo_prueba_prueba_pieza FOREIGN KEY(prueba_pieza_fk_tipo_prueba) REFERENCES Tipo_Prueba_Pieza(tipo_pp_id) ON DELETE CASCADE
);
...
CREATE TABLE Historico_Estatus_Prueba_Pieza(
    ...
    CONSTRAINT fk_prueba_pieza_historico FOREIGN KEY(hist_est_pru_piez_fk_prueba_pieza) REFERENCES Prueba_Pieza(prueba_pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_estatus_prueba_pieza_historico FOREIGN KEY(hist_est_pru_piez_fk_estatus_prueba_pieza) REFERENCES Estatus_Prueba_Pieza(estatus_pp_id) ON DELETE CASCADE
);
...
CREATE TABLE Pieza_Zona(
    ...
    CONSTRAINT fk_pieza_pieza_zona FOREIGN KEY(pieza_zona_fk_pieza) REFERENCES Pieza(pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_zona_pieza_zona FOREIGN KEY(pieza_zona_fk_zona) REFERENCES Zona(zona_id) ON DELETE CASCADE
);
...
CREATE TABLE Empleado_Prueba_Pieza(
    ...
    CONSTRAINT fk_empleado_empleado_prueba_pieza FOREIGN KEY(empleado_prueba_pieza_fk_empleado) REFERENCES Empleado(cod_empleado) ON DELETE CASCADE,
    CONSTRAINT fk_prueba_pieza_empleado_prueba_pieza FOREIGN KEY(empleado_prueba_pieza_fk_prueba_pieza) REFERENCES Prueba_Pieza(prueba_pieza_id) ON DELETE CASCADE
);
...
CREATE TABLE Pedido(
    ...
    CONSTRAINT fk_cliente_jur_pedido FOREIGN KEY(pedido_fk_cliente_jur) REFERENCES cliente_juridico(cod_cliente_juri) ON DELETE CASCADE,
    CONSTRAINT fk_cliente_nat_pedido FOREIGN KEY(pedido_fk_cliente_nat) REFERENCES Cliente_Natural(cod_client_nat) ON DELETE CASCADE,
    CONSTRAINT fk_sede_pedido FOREIGN KEY(pedido_fk_sede) REFERENCES Sede(sede_id) ON DELETE CASCADE,
    CONSTRAINT fk_historico_tasa_dolar_pedido FOREIGN KEY(pedido_fk_historico_tasa_dolar) REFERENCES Historico_Tasa_Dolar(H_tasa_id) ON DELETE CASCADE
);
...
CREATE TABLE Historico_Estatus_Pedido(
    ...
    CONSTRAINT fk_pedido_historico_estatus_pedido FOREIGN KEY(historico_estatus_pedido_fk_pedido) REFERENCES Pedido(pedido_id) ON DELETE CASCADE,
    CONSTRAINT fk_estatus_pedido_historico_estatus_pedido FOREIGN KEY(historico_estatus_pedido_fk_estatus_pedido) REFERENCES estatus_pedido(estatus_ped_id) ON DELETE CASCADE
);
...
CREATE TABLE Pedido_Metodo_Pago(
    ...
    CONSTRAINT fk_pedido_pedido_metodo_pago FOREIGN KEY(pedido_metodo_pago_fk_pedido) REFERENCES Pedido(pedido_id) ON DELETE CASCADE,
    CONSTRAINT fk_TDC_pedido_metodo_pago FOREIGN KEY(pedido_metodo_pago_fk_TDC) REFERENCES tdc(tdc_metodo_pago_cod) ON DELETE CASCADE,
    CONSTRAINT fk_TDD_pedido_metodo_pago FOREIGN KEY(pedido_metodo_pago_fk_TDD) REFERENCES tdd(tdd_metodo_pago_cod) ON DELETE CASCADE,
    CONSTRAINT fk_cheque_pedido_metodo_pago FOREIGN KEY(pedido_metodo_pago_fk_cheque) REFERENCES cheque(cheque_metodo_pago_cod) ON DELETE CASCADE,
    CONSTRAINT fk_efectivo_pedido_metodo_pago FOREIGN KEY(pedido_metodo_pago_fk_efectivo) REFERENCES efectivo(efectivo_metodo_pago_cod) ON DELETE CASCADE
);
...
CREATE TABLE odr_metodo_pago(
    ...
    CONSTRAINT fk_orden_odr_metodo_pago FOREIGN KEY(odr_metodo_pago_fk_orden) REFERENCES Orden_De_Reposicion(orden_id)  ON DELETE CASCADE,
    CONSTRAINT fk_TDC_odr_metodo_pago FOREIGN KEY(odr_metodo_pago_fk_TDC) REFERENCES tdc(tdc_metodo_pago_cod)  ON DELETE CASCADE,
    CONSTRAINT fk_TDD_odr_metodo_pago FOREIGN KEY(odr_metodo_pago_fk_TDD) REFERENCES tdd(tdd_metodo_pago_cod)  ON DELETE CASCADE,
    CONSTRAINT fk_cheque_odr_metodo_pago FOREIGN KEY(odr_metodo_pago_fk_cheque) REFERENCES cheque(cheque_metodo_pago_cod) ON DELETE CASCADE,
    CONSTRAINT fk_efectivo_odr_metodo_pago FOREIGN KEY(odr_metodo_pago_fk_efectivo) REFERENCES efectivo (efectivo_metodo_pago_cod) ON DELETE CASCADE
);
...
CREATE TABLE pieza_equipo (
    ...
    CONSTRAINT fk_pieza_pieza_equipo FOREIGN KEY(pieza_equipo_fk_pieza) REFERENCES Pieza(pieza_id) ON DELETE CASCADE,
    CONSTRAINT fk_equipo_pieza_equipo FOREIGN KEY(pieza_equipo_fk_equipo) REFERENCES Equipo(codigo_equipo) ON DELETE CASCADE
);
...
CREATE TABLE avion_equipo (
    ...
    CONSTRAINT fk_avion_avion_equipo FOREIGN KEY(avion_equipo_fk_avion) REFERENCES avion(avion_id) ON DELETE CASCADE,
    CONSTRAINT fk_equipo_avion_equipo FOREIGN KEY(avion_equipo_fk_equipo) REFERENCES Equipo(codigo_equipo) ON DELETE CASCADE
);
...
CREATE TABLE ma_mp(
    ...
    CONSTRAINT fk_modelo_avion_ma_mp FOREIGN KEY(ma_mp_fk_modelo_avion) REFERENCES Modelo_Avion(modelo_avion_id) ON DELETE CASCADE,
    CONSTRAINT fk_modelo_pieza_ma_mp FOREIGN KEY(ma_mp_fk_modelo_pieza) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE
);
...
CREATE TABLE Pieza_caracteristica (
    ...
    Constraint fk_pieza_caracteristica_pieza FOREIGN KEY (fk_modelo_pieza) REFERENCES Modelo_Pieza(m_pieza_id) ON DELETE CASCADE,
    Constraint fk_pieza_caracteristica_caracteristica FOREIGN KEY (fk_caracteristica) REFERENCES Caracteristica(caracteristica_id) ON DELETE CASCADE
);
